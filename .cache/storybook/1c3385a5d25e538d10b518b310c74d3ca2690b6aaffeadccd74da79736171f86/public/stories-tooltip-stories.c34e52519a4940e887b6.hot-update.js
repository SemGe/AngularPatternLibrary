...
let TooltipComponent = (() => {
  ...
  var TooltipComponent = class {
    ...
    showTooltip() {
      console.log('Tooltip wird angezeigt'); // Debug-Ausgabe
      this.isVisible = true;
    }
    hideTooltip() {
      console.log('Tooltip wird versteckt'); // Debug-Ausgabe
      this.isVisible = false;
    }
    static {
      this.propDecorators = {
...
//# sourceMappingURL=stories-tooltip-stories.c34e52519a4940e887b6.hot-update.js.map