...
let ModalDialogComponent = (() => {
  ...
  var ModalDialogComponent = class {
    ...
    constructor() {
      this.isModalOpen = false; // Variable zum Verwalten des Modals
    ...
    closeModal() {
      ...
      this.stopDragging(); // Dragging beim Schließen stoppen
    }
    startDragging(event) {
    ...
    onMouseUp() {
      this.stopDragging(); // Dragging beenden, wenn die Maustaste losgelassen wird
    }
    onMouseMove(event) {
      if (this.isDragging && this.modal) {
...
//# sourceMappingURL=stories-modal-dialog-stories.478f33c74f84ebf84e74.hot-update.js.map